...
module.exports = function (md, options) {
    ...
    md.renderer.rules.fence = (tokens, idx, options, env, self) => {
        ...
        if (prismLang) {
            ...
            if (caption) {
                result += `<figcaption><div class="carbon"><div class="dot red"></div><div class="dot yellow"></div><div class="dot green"></div></div><span class="lang">${langShow}</span>${caption}</figcaption>`;
            }
